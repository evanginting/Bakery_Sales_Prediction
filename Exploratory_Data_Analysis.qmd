...
train_data |>
  ggplot(aes(x = as.factor(month), y = Umsatz)) +
  geom_col()
```
...
```{r}
filtered_train_data |>
  ggplot(aes(x = Datum, y = Umsatz, colour = as.factor(KielerWoche))) +
  geom_point()

filtered_train_data |>
  ggplot(aes(x = as.factor(month), y = Umsatz, fill = as.factor(KielerWoche))) +
  geom_col()

filtered_train_data |>
  ggplot(aes(x = as.factor(month), y = Umsatz, fill = as.factor(Warengruppe))) +
  geom_col()
```
